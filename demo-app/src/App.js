   ...
   <div class="resume_left">
     ...
     <div class="resume_content">
       <div class="resume_item resume_info">
         <div class="title">
           <p class="bold">Ibrahim Akberov</p>
           <p class="regular">Programig</p>
         </div>
         <ul>
           <li>
             <div class="icon">
             ...
             <div class="data">
               21 Street, Sumgayit <br /> Azerbaijan
             </div>
           </li>
           <li>
             <div class="icon">
    ...
    <div class="resume_item resume_education">
      ...
      <ul>
            <li>
                ...
                <div class="info">
                     <p class="semi-bold">Web Programig (Texas University)</p> 
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!</p>
                </div>
            </li>
            <li>
              <div class="date">2009 - 2019</div>
              <div class="info">
